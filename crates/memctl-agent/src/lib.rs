...
const START_PREFIX: &str = "<!-- memctl:start";
const END_MARKER: &str = "<!-- memctl:end -->";
const PROTOCOL_VERSION: u32 = 1;

const BLOCK_BODY: &str = r#"## memctl
...
pub fn render_block(version: u32) -> String {
    ...
    out.push_str("<!-- memctl:start version=");
